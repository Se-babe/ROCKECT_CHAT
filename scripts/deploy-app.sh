...
echo ""
echo "Open this exact URL in your browser (not port 3000 if you run two stacks):"
echo "  $RC_URL"
echo "Then: Marketplace > Installed — look for UgaJapa Translation (or use ./scripts/app-status.sh)"
